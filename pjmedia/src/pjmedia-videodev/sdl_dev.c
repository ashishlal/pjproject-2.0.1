...
/* 
   For the code below refer raydium.org
   http://raydium.org/svn.php?f=/trunk/raydium/wrapper-opengles.c
   I am pasting the license notice below.
=============================
    Raydium - CQFD Corp.
    http://raydium.org/
...
/* +++lal 	
	...
	*/
	glOrthof(0.0, (float)strm->param.disp_size.w,
                (float)strm->param.disp_size.h, 0.0, 0.0, 1.0);
