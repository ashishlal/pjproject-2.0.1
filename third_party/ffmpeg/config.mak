...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cc=/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc --as='gas-preprocessor.pl /Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc' --nm=/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/nm --sysroot=/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.1.sdk --target-os=darwin --arch=i686 --cpu=i386 --enable-pic --extra-cflags='-arch i386 -I/Users/Ashish/mygithub/pjproject-2.0.1/third_party/ffmpeg/../x264/x264-i386/include' --extra-ldflags='-arch i386 -isysroot /Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.1.sdk -L/Users/Ashish/mygithub/pjproject-2.0.1/third_party/ffmpeg/../x264/x264-i386/lib' --prefix=compiled/i386 --enable-cross-compile --enable-nonfree --enable-gpl --disable-bzlib --disable-armv5te --disable-swscale-alpha --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-libx264 --enable-encoder=libx264 --enable-encoder=libx264rgb --enable-decoder=h264 --enable-encoder=h263 --enable-decoder=h263 --disable-asm --disable-debug
...
CFLAGS= -arch i386 -I/Users/Ashish/mygithub/pjproject-2.0.1/third_party/ffmpeg/../x264/x264-i386/include -march=i386 -std=c99 -fomit-frame-pointer -fPIC -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -mllvm -stack-alignment=16
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -arch i386 -I/Users/Ashish/mygithub/pjproject-2.0.1/third_party/ffmpeg/../x264/x264-i386/include -march=i386 -fPIC
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -arch i386 -isysroot /Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.1.sdk -L/Users/Ashish/mygithub/pjproject-2.0.1/third_party/ffmpeg/../x264/x264-i386/lib --sysroot=/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.1.sdk -Wl,-dynamic,-search_paths_first
