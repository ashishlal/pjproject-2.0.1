export PJDIR := /Users/Ashish/mygithub/pjproject-2.0.1
...
export CC_NAME := gcc
export TARGET_NAME := arm-apple-darwin11
export CROSS_COMPILE := arm-apple-darwin11-
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	-O2 -arch armv7 -isysroot /Applications/XCode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk -framework AudioToolbox -framework Foundation -L /Users/Ashish/mygithub/pjproject-2.0.1/third_party/sdl/build/armv7/build/.libs -L /Users/Ashish/mygithub/pjproject-2.0.1/third_party/ffmpeg/compiled/armv7/lib -lSDL2 -lavformat -lavcodec -lswscale -lavutil -lavdevice -lavfilter -framework OpenGLES -lz
